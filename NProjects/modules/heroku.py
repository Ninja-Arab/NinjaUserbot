...
from NProjects.helpers.misc import HAPP, in_heroku
...
┈──────────────────────┈
❏ **PENGGUNAAN DYNO SAAT INI**
├ App Name : {HEROKU_APP_NAME}
├ {AppHours} Jam - {AppMinutes} Menit
└ Persentase : {AppPercentage}%
┈──────────────────────┈
❏ **SISA DYNO BULAN INI**
...
@Client.on_message(filters.command("dyno", CMD_HANDLER) & filters.me)
